          ...
          <ScrollReveal delay={100}>
            <div className="card">
              <div className="card-body">
                <p>
                  O <strong>Santos Open Beach Tennis</strong>, realizado na Praia do Gonzaga, em Santos, reuniu cerca de <strong>700 atletas</strong> durante o feriadão de 1º de maio. Além das competições, o evento promoveu <strong>clínicas esportivas</strong> para alunos da rede municipal e atividades inclusivas com <strong>pessoas surdas</strong>, incentivando a prática do esporte e a integração social.
                </p>
                <br />
                <p>
                  A iniciativa teve como objetivo aproximar crianças e jovens do beach tennis, estimular hábitos saudáveis e transformar o campeonato em um grande <strong>evento esportivo e cultural</strong> para a cidade.
                </p>
          ...
          <div className="speaker-grid">
            <ScrollReveal delay={150}>
              <div className="speaker-card">
                ...
                <p className="speaker-text">
                  Atualmente, o Brasil possui cerca de <strong style={{ color: "var(--text)" }}>1,5 milhão de praticantes</strong> de beach tennis, sendo considerado o país com o maior número de jogadores da modalidade no mundo. Esse crescimento aconteceu principalmente nos últimos anos, com a popularização do esporte em praias, clubes e academias.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={220}>
              <div className="speaker-card">
                ...
                <p className="speaker-text">
                  Além de ser uma atividade de lazer, o beach tennis também se tornou um esporte muito importante para a <strong style={{ color: "var(--text)" }}>saúde, socialização e inclusão social</strong>. O aumento no número de praticantes mostra como o esporte está cada vez mais presente no cotidiano dos brasileiros e ganhando destaque no cenário esportivo mundial.
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container">
          ...
          <ScrollReveal delay={80}>
            <div className="card" style={{ marginBottom: 20 }}>
              <div className="card-body">
                <p>
                  O beach tennis melhora o condicionamento físico, a coordenação e a saúde mental — tudo isso ao ar livre, o que torna o hábito mais fácil de manter. O esporte aproxima pessoas de diferentes realidades e, com projetos inclusivos chegando a escolas e comunidades, virou também uma porta de entrada para quem antes não tinha acesso à atividade física.
                </p>
              </div>
            </div>
          </ScrollReveal>
